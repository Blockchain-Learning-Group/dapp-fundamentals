...
Usage:
   1. Try out your vote!
   2. Confirm user may only vote once.
...
- Advisable to clone this within the same directory as your hub.
```
blg $ git clone https://github.com/Blockchain-Learning-Group/exchange-complete.git
blg $ cd exchange-complete && npm install
```

- Start your ethereum client within your testrpc window.
```
$ testrpc
```
...
- Update [hub-template/app/client/js/home.js#L8](https://github.com/Blockchain-Learning-Group/dapp-fundamentals/blob/12d3b25c24d9059a2e91b58d850b498f6953e66d/solutions/Hub/app/client/js/home.js#L7) with new token and hub addresses and start the server.
```
...
```
exchange-complete $ truffle migrate --reset
```
...
- TODO: Pull the symbol directly from the token contract.
```
...
- Fund your parity account, BLG trainer will be able to send the required funds to each provided user address.
...
- Also don't forget to update the mapping of the address to token symbol for the ui. [exchange-complete/app/client/js/ether.js#L1221](https://github.com/Blockchain-Learning-Group/dapp-fundamentals/blob/12d3b25c24d9059a2e91b58d850b498f6953e66d/solutions/Exchange/app/client/js/ether.js#L1078).
```
