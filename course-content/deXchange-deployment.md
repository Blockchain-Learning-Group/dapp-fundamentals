...
__3. Connect to your `real` Ethereum client, parity.__
  ...
  ```
  ssh -g -4 -NL 8545:127.0.0.1:8545 user@52.242.24.198
  ```
  - *Example output:*
  ```
  root@7e7d419200b4:/blg/wallet-template# ssh -g -4 -NL 8545:127.0.0.1:8545 user@52.242.24.198
